...
<body>
   <main class="main">
      <div>
        ...
        <ul>
            <br/>
            <button type="button" class="btn btn-primary" onclick="location.href='Book/form-book.jsp';">Create book</button>

            <button type="button" class="btn btn-primary" onclick="location.href='Book/form-modifyBook.jsp';">modify book</button>

            <button type="button" class="btn btn-primary" onclick="location.href='Book/form-deleteBookA.jsp';">Delete book</button>
